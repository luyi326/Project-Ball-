...
/**
 * Modifyed for Beaglebone Black     - Yi
 */
...
/*=========================================================================
    ...
    #define ADS1115_ADDRESS_LOW             ADS1015_ADDRESS
    #define ADS1115_ADDRESS_HIGH            (ADS1015_ADDRESS + 1)
/*=========================================================================*/
...
class Adafruit_ADS1015 : public I2CBase
{
protected:
 ...
 public:
  ...
  void      readADC_prepareChannel(uint8_t channel);
  uint16_t  readADC_readPremaredChannel();

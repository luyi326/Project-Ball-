...
public:
    ...
    AccelStepper(uint8_t interface = AccelStepper::FULL4WIRE, BlackLib::gpioName pin1 = GPIO_44, BlackLib::gpioName pin2 = BlackLib::GPIO_26, BlackLib::gpioName pin3 = GPIO_46, BlackLib::gpioName pin4 = GPIO_65, bool enable = true);
    ...
    /// \sa setPinsInverted
    void    setEnablePin(gpioName enablePin = GPIO_NULL);
...
private:
    ...
    BlackLib::gpioName		_pin[4];
    BlackLib::BlackGPIO*	_BLACKPinPtr[4];
    ...
    BlackLib::gpioName		_enablePin;
    BlackLib::BlackGPIO*	_BLACKEnablePinPtr;
